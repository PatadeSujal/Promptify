...
const Navbar = () => {
  ...
  return (
    <div className="container w-[80%] flex justify-center mx-auto mt-2 ">
      <nav className="bg-white shadow-lg  z-50 w-full rounded-2xl static top-0">
              ...
              {suggestions.length > 0 && (
                <ul className="absolute top-full mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                  ...
                  <Link href="/post">
                    <button
                    type="button"
                    className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-4 py-2 text-center me-2 mb-2"
                    >
                    <span className="md:hidden font-extrabold text-2xl">+</span>
                    <span className="hidden md:inline">Post Yours</span>
                    </button>
                  </Link>
                  {/* Mobile menu button */}
